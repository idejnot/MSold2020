...
class Telemetry extends kit_1.AsyncCreatable {
    ...
    static async acknowledgeDataCollection() {
        ...
        try {
            ...
            const err = error;
            if (err.code === 'ENOENT') {
                if (!kit_1.env.getBoolean('SF_TELEMETRY_DISABLE_ACKNOWLEDGEMENT', false)) {
    ...
    upload() {
        ...
        const telemetryDebug = kit_1.env.getBoolean('SF_TELEMETRY_DEBUG', false);
 ...
 */
Telemetry.tmpDir = kit_1.env.getString('SF_TELEMETRY_PATH', (0, path_1.join)((0, os_1.tmpdir)(), 'sf-telemetry'));
