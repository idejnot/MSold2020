...
const messages = core_1.Messages.loadMessages('@salesforce/plugin-sobject', 'generate.object');
...
ObjectGenerate.aliases = ['generate:metadata:sobject'];
ObjectGenerate.deprecateAliases = true;
