...
const messages = core_1.Messages.loadMessages('@salesforce/plugin-sobject', 'generate.field');
    ...
    async run() {
        ...
        const responses = await this.prompt([
            ...
            },
            {
                ...
                validate: (n, answers) => (0, prompts_1.integerValidation)(n, 1, 18 - (answers.scale ?? 0)),
                name: 'precision',
...
FieldGenerate.aliases = ['generate:metadata:field'];
FieldGenerate.deprecateAliases = true;
FieldGenerate.flags = {
