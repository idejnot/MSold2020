...
const messages = core_1.Messages.loadMessages('@salesforce/plugin-data', 'bulkv2.delete');
class Delete extends bulkOperationCommand_1.BulkOperationCommand {
    async run() {
    ...
    async getCache() {
        return bulkDataRequestCache_1.BulkDeleteRequestCache.create();
    }
}
